...
@ManagedBean()
@ViewScoped
public class Vista_reporte_asistencia_estudiantes extends Vista_campostxt {
    ...
    public void imprimir_reporte_asistencias_estudiantes() {


        seleccionLista_grupo_modulo();
        System.out.println(txtgrupo_modulo);
...
//        acciones.cerrar_conexion_reportes();
    ...
    public void reporte_asistencias_estudiantes_excel(String a, String reporte_jasper) {
        Connection cc = devolver_conexion();
    ...
    public ArrayList<entiv_cronograma> getLista1() {
        ...
        v.crs = acciones_cronograma.getLista(txtpromocion, txtcodigo_dinamico);
        try {

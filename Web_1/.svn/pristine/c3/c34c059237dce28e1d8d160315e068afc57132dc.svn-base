    ...
    public void insertar() {
        if (valida.campos4_2(txtnombresmod, txtdescripcion, txtcodigomod, txtcreditos) == false) {
            ...
            if (comparar_numero_creditos(txtcodigomod, txtcreditos) == true) {
                ...
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Ya se ha completado el nÃºmero de crÃ©ditos para este mÃ³dulo", ""));
